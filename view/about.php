...
<?php include 'includes/header.php' ?>
   ...
   <section class="breadcrumb__area grey-bg  breadcrumb-height include-bg p-relative" data-background="../assets/img/breadcrumb/breadcurmb.jpg">
         <div class="container">
            <div class="row">
      ...
      <div class="tp-counter-area pb-90">
         <div class="container">
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".5s">
                  <div class="counter-item text-center">
                     <h4><span class="counter">850</span>+</h4>
                     <h3>Projects deliverd</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                  <div class="counter-item text-center">
                     <h4><span class="counter">24</span>+</h4>
                     <h3>Years of operation</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                  <div class="counter-item text-center">
                     <h4><span class="counter">84</span>+</h4>
                     <h3>Specialist Member</h3>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-30 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                  <div class="counter-item text-center">
              ...
              <div class="row">
                 <div class="col-xl-6 col-lg-6">
                    <div class="contact-us-sction-box mb-60">
                       <h4 class="tp-section-subtitle">Contact Us</h4>
                    ...
                    <div class="contact-info">
                       <div class="contact-info-item d-flex align-items-center">
                          ...
                          <div class="contact-loaction">
                             <a href="https://maps.app.goo.gl/Uhaq1sGSGzDjYVcU9" target="_blank">YouCode  <br> Youssoufia School</a>
                          </div>
                       </div>
                       <div class="contact-info-item d-flex align-items-center">
                          <div class="contact-icon">
                          ...
                          <div class="contact-loaction">
                             <a href="#"><span class="__cf_email__" data-cfemail="98ebede8e8f7eaecd8fef1fff5f9b6fbf7f5">info@yourinterface.com</span></a>
                          </div>
                       </div>
                       <div class="contact-info-item d-flex align-items-center">
                          <div class="contact-icon">
