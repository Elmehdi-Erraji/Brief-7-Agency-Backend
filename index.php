...
<body>
   ...
   <header role="banner" >
      <nav class="navbar navbar-expand-md navbar-dark bg-light" >
        <div class="container">
          ...
          <a class="navbar-brand" href="index.php" ><img src="assets/img/logO/Untitled_design__12_-removebg-preview.png" alt="" height=55px"></a>
          <button class="navbar-toggler" style="background-color: #30B7FF;" type="button" data-toggle="collapse" data-target="#navbarsExample05" aria-controls="navbarsExample05" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05" >
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-dark" href="view/about.php">About</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item text-dark" href="view/contact.php">Contact us</a>
                  <a class="dropdown-item text-dark" href="view/services.php">Services</a>
                  <a class="dropdown-item text-dark" href="view/Login.php">LogIn</a>
                </div>
              </li>
   ...
   <main>
      ...
      <div class="tp-hero-area hero-grideant-bg" data-background="assets/img/slider/slider-grident-bg.png" style="background: linear-gradient(180deg, #30B7FF 0%, rgba(19, 135, 236, 0.59) 49.37%, rgba(48, 183, 255, 0.16) 100%);">
         <div class="container" >
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="tp-hero__wrapper-thumb p-relative">
                     <div class="tp-hero-shape-one">
                        <img src="assets/img/slider/hero-star-shape.png" alt="" width="#" height="#">
                     </div>
                     <div class="tp-hero-shape-two">
                        <img src="assets/img/slider/hero-circle-shape.png" alt=""width="#" height="#">
                     </div>
                     <div class="tp-hero-shape-three">
                        <img src="assets/img/slider/hero-angel-shape.png" alt=""width="#" height="#">
                     </div>
                     <div class="tp-hero-shape-four">
                        <img src="assets/img/slider/hero-star-sm-shape.png" alt=""width="#" height="#">
                     </div>
                     <div class="tp-hero__thumb text-start text-lg-end wow tpfadeRight" data-wow-duration=".9s" data-wow-delay="1.2s">
                        <img src="assets/img/slider/hero-1.png" alt="" width="#" height="#">
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="tp-slider-exprience">
                     ...
                     <div class="tp-slider-exprience__client-info d-flex align-items-center">
                        <div class="tp-slider-exprience__img">
                           <img src="assets/img/slider/hero-sm-img.png" alt="" width="#" height="#">
                        </div>
                        <div class="tp-slider-exprience__meta">
                           <h5 class="tp-client-name">Darrell Steward</h5>
                           <span>Founder of (YourInterface <i class="fas fa-star"></i> - 5 star Agency)</span>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-xl-5 col-lg-5 order-2 order-lg-1 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
                  <div class="tp-ab-wrapper p-relative">
                     <div class="tp-ab-shape-one z-index-3">
                        <img src="assets/img/about/about-shape-1.png" alt="" width="#" height="#">
                     </div>
                     <div class="tp-ab-shape-two z-index-3">
                        <img src="assets/img/about/about-circle-shape.png" alt="" width="#" height="#">
                     </div>
                     <div class="tp-about-thumb">
                        <img src="assets/img/about/about-img.jpg" alt="" width="#" height="#">
                     </div>
                  </div>
               </div>
      ...
      <!-- tp-case-area-start -->
      <div class="tp-case-area case-bg case-space"  style="background: linear-gradient(180deg, #30B7FF 0%, rgba(19, 135, 236, 0.59) 49.37%, rgba(48, 183, 255, 0.16) 100%);">
         <div class="container">
                           ...
                           <div class="tp-testimonial-item__wrapper d-flex justify-content-between align-items-center">
                              <div class="tp-testimonial-item__info d-flex align-items-center">
                                 <div class="tp-testimonial-item__info-img">
                                    <img src="assets/img/testimonial/testi-img-1.png" alt="" width="#" height="#">
                                 </div>
                     ...
                     <div class="col-xl-12 col-lg-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                        <div class="tp-testimonial-item testimonial-bg-color-2 mb-30">
                           ...
                           <div class="tp-testimonial-item__wrapper d-flex justify-content-between align-items-center">
                              <div class="tp-testimonial-item__info d-flex align-items-center">
                                 <div class="tp-testimonial-item__info-img">
                                    <img src="assets/img/testimonial/testi-img-2.png" alt="" width="#" height="#">
                                 </div>
                                 <div class="tp-testimonial-item__info-text">
                     ...
                     <div class="col-xl-12 col-lg-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                        <div class="tp-testimonial-item testimonial-bg-color-3 mb-30">
                           ...
                           <div class="tp-testimonial-item__wrapper d-flex justify-content-between align-items-center">
                              <div class="tp-testimonial-item__info d-flex align-items-center">
                                 <div class="tp-testimonial-item__info-img">
                                    <img src="assets/img/testimonial/testi-img-3.png" alt="" width="#" height="#">
                                 </div>
                                 <div class="tp-testimonial-item__info-text">
      ...
      <!-- tp-blog-area-start -->
      <div class="tp-blog-area blog-grident-bg blog-space"  style="background: linear-gradient(180deg, #30B7FF 0%, rgba(19, 135, 236, 0.59) 49.37%, rgba(48, 183, 255, 0.16) 100%);">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-xl-6">
               ...
               <div class="row gx-20">
                  <div class="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".4s">
                     <div class="tp-blog-item mb-30">
                        <div class="tp-blog-item__thumb fix">
                           <a title="go here" href="pages/blog.html"><img src="assets/img/blog/blog-1.jpg" alt="" width="#" height="#"> </a>
                        </div>
                        ...
                        <div class="tp-blog-item__blog-title">
                           <h4 class="tp-blog-title-lg"><a title="go here" href="pages/blog.html">How to Increase Your ROI Through scientific SEM?</a>
                           </h4>
                        </div>
                        <div class="tp-blog-item__button">
                           <div class="tp-link tp-link-green">
                              <a title="go here" href="pages/blog.html">
                                 <svg width="34" height="16" viewbox="0 0 34 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M33.7071 8.70711C34.0976 8.31659 34.0976 7.68342 33.7071 7.2929L27.3431 0.928935C26.9526 0.53841 26.3195 0.53841 25.9289 0.928934C25.5384 1.31946 25.5384 1.95262 25.9289 2.34315L31.5858 8L25.9289 13.6569C25.5384 14.0474 25.5384 14.6805 25.9289 15.0711C26.3195 15.4616 26.9526 15.4616 27.3431 15.0711L33.7071 8.70711ZM-8.74228e-08 9L33 9L33 7L8.74228e-08 7L-8.74228e-08 9Z" fill="#202026"></path>
                                 </svg>
                                 <span>Read MORe</span>
                  ...
                  <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay=".7s">
                     <div class="tp-blog-item mb-30">
                        <div class="tp-blog-item__thumb fix">
                           <a title="go here" href="pages/blog.html"><img src="assets/img/blog/blog-2.jpg" alt="" width="#" height="#"></a>
                        </div>
                        <div class="tp-blog-item__tag">
                           <span>Design</span>
                           <span class="tag-color-green">February. 20.2022</span>
                        ...
                        <div class="tp-blog-item__blog-title">
                           <h4 class="tp-blog-title-lg"><a title="go here" href="pages/blog.html">ECommerce Marketing Statistics You Should Kno</a></h4>
                        </div>
                        <div class="tp-blog-item__button">
                           <div class="tp-link tp-link-green">
                              <a title="go here" href="pages/blog.html">
            ...
            <div class="row">
                  ...
                  <div class="tp-footer-widget z-index-3">
                     ...
                     <div class="tp-footer-widget__list">
                        <ul>
                           ...
                           <li><a title="go here" href="#">Integrations</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-2 col-md-3 col-6 mb-30">
                  <div class="tp-footer-widget footer-space-one z-index-3">
                     ...
                     <div class="tp-footer-widget__list">
                        <ul>
                           <li><a title="go here" href="#">Web-designers</a></li>
                           <li><a title="go here" href="#">Marketers</a></li>
                           <li><a title="go here" href="#">Small Business</a></li>
                           <li><a title="go here" href="#">Website Builder</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-xl-2 col-lg-2 col-md-3 col-6 mb-30">
                  <div class="tp-footer-widget footer-space-two z-index-3">
                     ...
                     <div class="tp-footer-widget__list">
                        <ul>
                           <li><a title="go here" href="#">Academy</a></li>
                           <li><a title="go here" href="pages/blog.html">Blog</a></li>
                           <li><a title="go here" href="#">Themes</a></li>
                           <li><a title="go here" href="#">Hosting</a></li>
                           <li><a title="go here" href="#">Developers</a></li>
                           <li><a title="go here" href="pages/contact.html">Support</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="tp-footer-widget z-index-3">
                     ...
                     <div class="tp-footer-widget__list">
                        <ul class="footer-position">
                           <li><a title="go here" href="#" target="_blank">
                              <span><i class="fal fa-map-marker-alt"></i></span>
                              Wisconsin Ave, Suite 700
                              Chevy Chase, Maryland 20815</a>
                           </li>
                           
                           <li><a title="go here" href="tel:778886664">
               ...
               <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-5 col-12">
                     <div class="copyright-right-side text-center text-lg-end">
                        <ul>
                           <li><a title="go here" href="#">Privacy Policy</a></li>
                           <li><a title="go here" href="#">Terms of Use</a></li>
                           <li><a title="go here" href="#">Sales and Refunds</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
